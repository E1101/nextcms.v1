...
define(["dojo/_base/declare"], function(dojoDeclare) {
	var clazz = dojoDeclare("file.js.views.FileFormatter", null, {});
	
	clazz.formatPermissions = function(/*String*/ perms) {
		// summary:
	...
	clazz.formatSize = function(/*Integer*/ size, /*String*/ zeroString) {
		// summary:
		...
		var format = clazz._formatNumber;
		switch (true) {
	...
	clazz._formatNumber = function(/*Number*/ number, /*Integer*/ decimals, /*String*/ decPoint, /*String*/ thousandsSeparator) {
		// summary:
