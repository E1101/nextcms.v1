		...
		switch ($format) {
			case 'json':
				...
				$data = array(
					...
					// Paginator
					'paginator' => $this->view->paginator('slidingToolbar')->render($paginator, "javascript: require(['dojo/topic'], function(dojoTopic) { dojoTopic.publish('/app/poll/poll/list/onGotoPage', __PAGE__); }); "),
				);
