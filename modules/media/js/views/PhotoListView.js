...
define([
	...
	"media/js/views/PhotoItemView"
], function(dojoDeclare, dojoDom, dojoDomConstruct, dijitRegistry) {
	return dojoDeclare("media.js.views.PhotoListView", null, {
		// _id: String
		_id: null,
		...
		_init: function() {
			var that = this;
			this._photoItemMap = {};
			dojo.query(".module-media-photo", this._id).forEach(function(node, index, arr) {
				var photoItemView = new media.js.views.PhotoItemView(node, that);
				that._photoItemMap[photoItemView.getPhoto().photo_id + ""] = photoItemView;
			});
			...
			if (core.js.base.controllers.ActionProvider.get("media_photo_copy").isAllowed
				...
				var container = dojo.query(".module-media-photos", this._id)[0];
				if (container) {
		...
		getNumPhotoItemViews: function() {
			...
			return dojo.query(".module-media-photo", this._domNode).length;
		},
		...
		getPhotoItemViews: function() {
			...
			var that = this;
			dojo.query(".module-media-photo", this._id).forEach(function(node, index, arr) {
				photoItemViews.push(new media.js.views.PhotoItemView(node, that));
			});
		...
		removePhotoItemView: function(/*media.js.views.PhotoItemView*/ photoItemView) {
			...
			dojoDomConstruct.destroy(photoItemView.getDomNode());
		},
		...
		showSlide: function(/*media.js.views.PhotoItemView*/ photoItemView) {
			...
			dojoDeclare("media.js.views.Lightbox", [dojox.image.Lightbox], {
