...
define([
...
], function(dojoDeclare, dojoLang, dojoAspect, dojoDomAttr, dojoDomClass, dojoHash, dojoIoQuery, dojoRequestXhr, dojoTopic) {
	return dojoDeclare("core.js.controllers.UserController", null, {
		...
		lockRole: function(/*core.js.views.RoleItemView*/ roleItemView) {
			...
			var that   = this;
			dojoRequestXhr(core.js.base.controllers.ActionProvider.get("core_role_lock").url, {
				data: {
					role_id: roleId
				},
				handleAs: "json",
			...
			if (!roleItemView.nameEditBox) {
				roleItemView.nameEditBox = new dijit.InlineEditBox({
					...
					onChange: function(newName) {
						...
						if (newName != "") {
							dojoRequestXhr(core.js.base.controllers.ActionProvider.get("core_role_rename").url, {
								data: {
									role_id: roleId,
									name: newName
								},
		...
		searchRoles: function(/*Object*/ criteria) {
			...
			dojoRequestXhr(core.js.base.controllers.ActionProvider.get("core_role_list").url, {
				data: {
					q: q
				},
				method: "POST"
		...
		activateUser: function(/*core.js.views.UserItemView*/ userItemView) {
			...
			dojoRequestXhr(core.js.base.controllers.ActionProvider.get("core_user_activate").url, {
				data: {
					user_id: userId
				},
				handleAs: "json",
		...
		updateAvatar: function(/*core.js.views.UserItemView*/ userItemView, /*String*/ avatarUrl) {
			...
			var that = this;
			dojoRequestXhr(core.js.base.controllers.ActionProvider.get("core_user_avatar").url, {
				data: {
					user_id: userItemView.getUser().user_id,
					url: avatarUrl
				},
