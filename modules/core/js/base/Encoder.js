...
define([
	...
	"dojo/_base/declare",
	"dojo/json"
], function(dojoArray, dojoDeclare, dojoJson) {
	var clazz = dojoDeclare("core.js.base.Encoder", null, {});
	
	clazz.encode = function(/*Object*/ object, /*Array?*/ properties) {
		// summary:
		...
		var data = {};
		if (properties) {
			dojoArray.forEach(properties, function(name) {
		...
		var encodedString = dojoJson.stringify(data);
		encodedString = clazz.encodeBase64(encodedString);
		encodedString = clazz.rawEncodeUrl(encodedString);
		return encodedString;	// String
	};
	
	clazz.decode = function(/*String*/ encodedString) {
		// summary:
		//		Decodes an encoded string which is encoded by the core.js.base.Encoder.encode() method
		var object = clazz.rawDecodeUrl(encodedString);
		object = clazz.decodeBase64(object);
		object = dojoJson.parse(object);
		return object;	// Object
	};
	
	clazz.encodeUtf8 = function(/*String*/ str) {
		// summary:
	...
	clazz.decodeUtf8 = function(/*String*/ str) {
		// summary:
	...
	clazz.encodeBase64 = function(/*String*/ data) {
		// summary:
	...
	clazz.decodeBase64 = function(/*String*/ data) {
		// summary:
		...
		dec = tmpArr.join("");
		dec = clazz.decodeUtf8(dec);
	
		return dec;		// String
	};
	
	clazz.encodeUrl = function(/*String*/ url) {
		// summary:
		//		URL-encodes string
		// description:
	...
	clazz.decodeUrl = function(/*String*/ url) {
		// summary:
	...
	clazz.rawEncodeUrl = function(/*String*/ url) {
		// summary:
		//		URL-encodes string
		// description:
	...
	clazz.rawDecodeUrl = function(/*String*/ url) {
		// summary:
