...
define([
	...
	return dojoDeclare("media.js.controllers.VideoMediator", null, {
		// summary:
		...
		setVideoContextMenu: function(/*media.js.views.VideoContextMenu*/ videoContextMenu) {
			...
			dojoAspect.after(videoContextMenu, "onContextMenu", dojoLang.hitch(this, "onContextMenu"), true);
		},
		...
		setVideoListView: function(/*media.js.views.VideoListView*/ videoListView) {
			...
			dojoAspect.after(videoListView, "onPopulateVideos", dojoLang.hitch(this, "onPopulateVideos"));
		},
