...
define([
	...
	return dojoDeclare("media.js.controllers.PhotoMediator", null, {
		// summary:
		...
		setPhotoContextMenu: function(/*media.js.views.PhotoContextMenu*/ photoContextMenu) {
			...
			dojoAspect.after(photoContextMenu, "onContextMenu", dojoLang.hitch(this, "onPhotoItemViewMouseDown"), true);
		},
		...
		setPhotoListView: function(/*media.js.views.PhotoListView*/ photoListView) {
			...
			dojoAspect.after(photoListView, "onPopulatePhotos", dojoLang.hitch(this, "onPopulatePhotos"), true);
		},
