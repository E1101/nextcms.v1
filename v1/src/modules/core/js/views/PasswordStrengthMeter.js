...
require([
	...
	"dojo/dom-construct",
	"core/js/base/I18N"
], function(dojoDeclare, dojoDomAttr, dojoDomClass, dojoDomConstruct) {
	return dojoDeclare("core.js.views.PasswordStrengthMeter", null, {
		// _id: String
		// 		The container's Id
		_id: null,
		...
		getScore: function(/*String*/ password) {
			...
			// 		- If the password is less than 6 characters then score = 0
		...
		checkPassword: function(/*String*/ password) {
			...
			dojoDomClass.add(this._id, "module-core-password");
			var score = this.getScore(password);
			
			// The container showing the percent bar
			dojoDomConstruct.create("div", {
				className: "module-core-password-percent-container"
			}, this._id);
			
			// The percent bar
			dojoDomConstruct.create("div", {
				style: "width: " + ((score < 10) ? 10 : score) + "%",
				className: "module-core-password-percent"
			}, this._id);
			...
			dojoDomConstruct.create("div", {
				innerHTML: status,
				className: "module-core-password-label"
			}, this._id);
		},
